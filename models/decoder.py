...
class AttDecoder(nn.Layer):
    ...
    def __init__(self, params):
        ...
        # word gru
        # weight_attr1 = paddle.ParamAttr(initializer=nn.initializer.Orthogonal())
        # weight_attr2 = paddle.ParamAttr(initializer=nn.initializer.Orthogonal())
        # bias_attr1 = paddle.ParamAttr(initializer=nn.initializer.Constant(value=0.0))
        # bias_attr2 = paddle.ParamAttr(initializer=nn.initializer.Constant(value=0.0))
        # self.word_input_gru = nn.GRUCell(self.input_size, self.hidden_size, weight_ih_attr=weight_attr1, weight_hh_attr=weight_attr2, bias_ih_attr= bias_attr1,bias_hh_attr= bias_attr2)
