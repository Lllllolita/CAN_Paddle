...
class Inference(nn.Layer):
    ...
    # def forward(self, images, labels, name, is_train=False):
        ...
        # word_probs, _ = self.decoder(cnn_features, counting_preds, is_train=is_train)
...
class AttDecoder(nn.Layer):
    ...
    def forward(self, cnn_features, counting_preds, is_train=False):
        ...
        word_probs = []
        # word_value= 1
        word_probs = [paddle.ones([1],dtype='int64') for i in range(200)]
        # print(word_probs)
        # word_alphas = []
        # debug新加的变量
        # word=paddle.to_tensor(paddle.ones([1],dtype='int32'))
        ...
        #eos_index=200
        # padding_index:int=200
        # padding_list:list=[112]
